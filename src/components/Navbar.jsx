...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <div
      className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 text-gray-600 border-b border-borderColor relative translate-all ${
      ...
      >
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          ...
          <button
            ...
            className="cursor-pointer px-8 py-2 bg-blue-500 hover:bg-blue-800 transition-all text-white rounded-lg"
          >
            Login
          </button>
        </div>
